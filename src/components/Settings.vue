  ...
  <div class="card is-fullwidth margin-dash">
    <div class="card-content">
      ...
      <p>These terms and conditions outline the rules and regulations for the use of  Incentify's Website. <br />
        ...
        <address>
          101 W. Broadway Ste 1100 , <br />
          San Diego, CA 92101<br />
          United States<br />
        </address>
        By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Incentify's website if you do not accept all of the terms and conditions stated on this page.
      </p>
      ...
      <h2>Cookies</h2>
      <p>We employ the use of cookies. By using <a href="http://www.incentify.life" onclick="__gaTracker('send', 'event', 'outbound-article', 'http://www.incentify.life', 'Incentify');" title="Incentify">Incentify</a>'s website you consent to the use of cookies in accordance with Incentify’s privacy policy.</p>
      ...
      <h2>License</h2>
      <p>Unless otherwise stated, Incentify and/or it’s licensors own the intellectual property rights for all material on Incentify All intellectual property rights are reserved. You may view and/or print pages from http://www.incentify.life for your own personal use subject to restrictions set in these terms and conditions.</p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from http://www.incentify.life</li>
        <li>Sell, rent or sub-license material from http://www.incentify.life</li>
        <li>Reproduce, duplicate or copy material from http://www.incentify.life</li>
      </ul>
      ...
      <h3>User Comments</h3>
        ...
        <li>You hereby grant to <strong>Incentify</strong> a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
      </ol>
      ...
      <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail to <a href="mailto:jason@incentify.life" title="send an email to jason@incentify.life">jason@incentify.life</a>. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.</p>
      ...
      <p>To the extent that the website and the information on the website is provided free of charge, we will not be liable for any loss or damage of any nature.</p>
      </div>
    </div>
  </div>
  </div>
    ...
    <div class="card-content">
      <div class="content">
        <div v-on:click = "showMission = !showMission" v-show = "showMission"><strong>Mission Statement</strong><i class="fa fa-plus is-pulled-right" style="font-size: 60px;" aria-hidden="true"></i></div>
         <div v-on:click = "showMission = !showMission" v-show = "!showMission"><strong>Mission Statement</strong><i class="fa fa-minus is-pulled-right" style="font-size: 60px;" aria-hidden="true"></i></div>
